...
export function BlogPost() {
  return (
    <section className="w-full max-w-6xl mx-auto flex flex-col items-center px-4 py-20">
      <Button placeholder={"Texto"}  color="gray" className="mb-3" size="sm">
        BLOG
      </Button>
      <Typography placeholder={"Texto"}  variant="h3" className="text-center" color="blue-gray">
      ...
      <div className="mt-10 gap-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        <div className=" md:border-r px-3 border-blue-gray-100">
          <div className="!border-b  border-blue-gray-100 mb-5">
            <Card placeholder={"Texto"}  shadow={false} className="p-0">
              <CardBody placeholder={"Texto"}  className="p-0 pb-5">
                <Typography placeholder={"Texto"} 
                  variant="h3"
                ...
                <Typography placeholder={"Texto"}  className="text-normal mb-4 !text-base text-blue-gray-500 ">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <Typography placeholder={"Texto"}  className="!font-bold !text-sm text-gray-900">
                      Mathew Glock
                    </Typography>
                    <Typography placeholder={"Texto"}  className="!font-normal !text-xs text-gray-500">
                      Author
                    </Typography>
                  </div>
                </div>
          ...
          <div className="!border-b  border-blue-gray-100 mb-6">
            <Card placeholder={"Texto"}  shadow={false} className="p-0">
              <CardBody placeholder={"Texto"}  className="p-0 pb-5">
                ...
                <Typography placeholder={"Texto"}  className="!font-bold !text-sm text-gray-700">
                  by Mathew Glock
                </Typography>
              </CardBody>
            </Card>

...
export default function Rerservacion() {
  ...
  const { habitacion,total } = useHabitacion();
  ...
  return (
    ...
    <div className="flex mt-28 justify-center">
      <FormClientes />
      <Card className=" w-full max-w-[22rem] shadow-lg justify-center ">
        ...
        <CardBody>
          ...
          <Typography color="gray">{habitacion.precio}</Typography>
          <Typography color="gray">Total : {total}</Typography>
        </CardBody>
